export default class player{
    constructor(Mesh, id, speed, scaling, scene) {
        this.Mesh = Mesh;
        this.id = id;
        this.scene = scene;
    ...
    calculateBoundingBoxParameters() {
        ...
        let childrenMeshes = this.Mesh.getChildren();
    ...
    createBoundingBox() {
        ...
        bounder.position = this.Mesh.position.clone();
